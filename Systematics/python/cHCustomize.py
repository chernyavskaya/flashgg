...
class cHCustomize():
    ...
    def variablesToDump(self):
        ...
        if(self.customize.cHTagsOnly):
            ...
            variables += [
                "leadingJet_DeepFlavour_probc := leadJet().bDiscriminator('mini_pfDeepFlavourJetTags:probc')",#FIXME make the ctag type configurable?
    ...
    def customizeTagSequence(self):
        ...
        if self.customize.cHTagsOnly:
            ...
            self.process.flashggTagSequence.remove(self.process.flashggGluGluHMVA)
