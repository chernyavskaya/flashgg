...
#    process.source = cms.Source("PoolSource",fileNames=cms.untracked.vstring('root://eoscms.cern.ch//eos/cms/store/mc/RunIIFall17MiniAOD/GluGluToHHTo2B2G_node_SM_13TeV-madgraph/MINIAODSIM/94X_mc2017_realistic_v10-v1/00000/2E0E165D-8E05-E811-909C-FA163E80AE1F.root'))
    process.source = cms.Source("PoolSource",fileNames=cms.untracked.vstring('root://cms-xrd-global.cern.ch//store/mc/RunIIFall17MiniAOD/GluGluToHHTo2B2G_node_12_13TeV-madgraph/MINIAODSIM/94X_mc2017_realistic_v10-v1/00000/560088DF-0205-E811-8342-6CC2173C9150.root'))                                 


#    process.GlobalTag = GlobalTag(process.GlobalTag,'92X_upgrade2017_TSG_For90XSamples_V2','')
#    process.source = cms.Source("PoolSource",fileNames=cms.untracked.vstring("/store/mc/PhaseIFall16MiniAOD/GluGluHToGG_M-70_13TeV_powheg_pythia8/MINIAODSIM/FlatPU28to62HcalNZSRAW_PhaseIFall16_HIG067_90X_upgrade2017_realistic_v6_C1-v1/50000/34873FEE-9B96-E711-BC58-0090FAA57960.root"))
else:
