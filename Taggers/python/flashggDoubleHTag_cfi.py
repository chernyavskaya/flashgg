...
flashggDoubleHTag = cms.EDProducer("FlashggDoubleHTagProducer",
                                   ...
                                   BTagType_probb = cms.untracked.string('pfDeepCSVJetTags:probb'), #string for btag algorithm
				   BTagType_probbb = cms.untracked.string('pfDeepCSVJetTags:probbb'), #string for btag algorithm
